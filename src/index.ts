...
export class ExtendedMap<K, V> extends Map<K, V> {
     ...
     * @returns The new map.
     */
    public flatMap <T> (callbackfn: (value: V, key: K, map: this) => ExtendedMap<K, T>, thisArg?: any): ExtendedMap<K, T> {
     ...
     */
    public reduce <T> (callbackfn: (previousValue: T, currentValue: V, currentIndex: K, map: this) => T, initialValue?: T): T {
